...
KNOWN_SOURCES = [
    {"url": "https://techcrunch.com", "name": "TechCrunch", "topics": ["tech", "startups", "ai", "technology"], "lang": "en"},
    {"url": "https://theverge.com", "name": "The Verge", "topics": ["tech", "gadgets", "technology"], "lang": "en"},
    {"url": "https://wired.com", "name": "Wired", "topics": ["tech", "science", "ai", "technology"], "lang": "en"},
    {"url": "https://arstechnica.com", "name": "Ars Technica", "topics": ["tech", "science", "technology"], "lang": "en"},
    {"url": "https://hipertextual.com", "name": "Hipertextual", "topics": ["tech", "ciencia", "tecnología"], "lang": "es"},
    {"url": "https://xataka.com", "name": "Xataka", "topics": ["tech", "gadgets", "tecnología"], "lang": "es"},
    {"url": "https://infobae.com", "name": "Infobae", "topics": ["noticias", "argentina", "latam"], "lang": "es"},
    {"url": "https://lanacion.com.ar", "name": "La Nación", "topics": ["noticias", "argentina", "política"], "lang": "es"},
    {"url": "https://clarin.com", "name": "Clarín", "topics": ["noticias", "argentina", "deportes"], "lang": "es"},
    {"url": "https://bbc.com/mundo", "name": "BBC Mundo", "topics": ["noticias", "internacional", "mundo"], "lang": "es"},
]
...
def extract_intent(query: str) -> dict[str, Any]:
    ...
    topic_keywords = [
        "tech", "tecnología", "technology", "ai", "inteligencia artificial",
        "startups", "emprendimiento", "ciencia", "science", "política",
        "deportes", "sports", "economía", "economy", "finanzas", "finance",
        "climate", "clima", "environment", "medio ambiente", "gaming",
        "videojuegos", "crypto", "blockchain", "machine learning", "ml",
    ]
