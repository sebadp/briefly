...
def upgrade() -> None:
    ...
    sa.Column('natural_language_query', sqlmodel.sql.sqltypes.AutoString(length=500), nullable=False),
    sa.Column('refresh_interval_minutes', sa.Integer(), nullable=False),
    sa.Column('interpreted_topics', sa.JSON(), nullable=True),
    sa.Column('interpreted_language', sqlmodel.sql.sqltypes.AutoString(length=10), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
